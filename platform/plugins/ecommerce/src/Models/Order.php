...
use Botble\Driver\Models\orderAcceptStatus;
...
class Order extends BaseModel
{
    ...
    {
        return $this->hasOne(Store::class, 'id', 'store_id')->select(['id', 'name', 'email', 'phone', 'address', 'country', 'state', 'city', 'zip_code', 'shop_lat', 'shop_long']);
    }
    ...
    public function orderAcceptStatus(): HasOne
    {
        return $this->hasOne(orderAcceptStatus::class); // Adjust 'order_id' and 'id' to match your foreign keys
    }
}
